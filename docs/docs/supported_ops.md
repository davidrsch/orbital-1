...
| `ScatterElements`           | scatter-update ops (update sparse indices)                   | ❌ Registered stub; raises `NotImplementedError` — tabular SQL cannot express sparse scatter semantics                                                                                                    |
...
| `Shape`                     | ONNX shape introspection                                     | ❌ Registered stub; raises `NotImplementedError` — tabular SQL has no column-count introspection at query time                                                                                            |
