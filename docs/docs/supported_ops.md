...
| `ConvTranspose`             | PyTorch `nn.ConvTranspose1d`, decoders                       | 1-D (weight rank 3) only; `group=1`; `output_padding`; `auto_pad` NOTSET/VALID/SAME_UPPER/SAME_LOWER; dilations ≥ 1 supported                                                                             |
