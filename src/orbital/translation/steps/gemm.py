...
class GemmTranslator(Translator):
    ...
    def process(self) -> None:
        ...
        # transA=1: In the orbital tabular context A is always a flat row-vector
        # (one feature per column), so transposing it is semantically a no-op.
        # The computation proceeds identically to transA=0.
